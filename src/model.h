...
class Model {
  ...
  public:
    ...
    void predict(const std::vector<int32_t>&, const std::vector<int32_t>&,int32_t,
    ...
    void findKBest(int32_t, std::vector<std::pair<real, int32_t>>&,
                   Vector&, Vector&) const;
    void update(const std::vector<int32_t>&, const std::vector<int32_t>&, int32_t, real);
    void update(const std::vector<int32_t>&, int32_t, real){return;};
    void computeHidden(const std::vector<int32_t>&, const std::vector<int32_t>&, Vector&) const;
